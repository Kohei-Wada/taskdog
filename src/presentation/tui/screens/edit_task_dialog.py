...
class EditTaskDialog(BaseModalDialog[tuple[str, int, str | None] | None]):
    """Modal dialog for editing an existing task with keyboard shortcuts."""
    ...
    def __init__(self, task: Task, *args, **kwargs):
        """Initialize the dialog with existing task data.
    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(id="edit-task-dialog"):
            yield Label("[bold cyan]Edit Task[/bold cyan]", id="dialog-title")
            yield Label(
            ...
            with Vertical(id="form-container"):
                ...
                yield Input(
                    ...
                    id="priority-input",
                    type="integer",
                    value=str(self.task_to_edit.priority),
                )
                ...
                yield Input(
                    ...
                    id="deadline-input",
                    value=self.task_to_edit.deadline if self.task_to_edit.deadline else "",
                )
