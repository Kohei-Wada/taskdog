...
from presentation.api.dependencies import initialize_api_context, set_api_context
...
def create_app() -> FastAPI:
    ...
    app.include_router(relationships_router, prefix="/api/v1/tasks", tags=["relationships"])
