...
- Planned periods (background shading)
- Actual progress (colored symbols: � for IN_PROGRESS, � for COMPLETED,  for FAILED)
...
Outputs all tasks in JSON format for debugging or backup purposes.
